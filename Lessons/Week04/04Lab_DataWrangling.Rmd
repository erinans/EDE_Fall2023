...
#whatis class of depth numeric, lake id factro?
#wan to query for depth
...
NTL.phys.data.Tuesday.1990<-filter(NTL.phys.data.Tuesday, year4 %in%c(1990:1999))

#daynum, make new column for month or convert into month before
...
NTL.phys.data.Tuesday.1990.1999.July <-
  NTL.phys.data.Tuesday.1990 %>%
