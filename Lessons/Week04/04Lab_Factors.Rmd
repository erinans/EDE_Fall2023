...
# same thing as thing above knitr::opts_chunk$set(message = FALSE, warning = FALSE)
#Read packages
#install.packages('here')
library(tidyverse);library(lubridate);library(here) #here is another way of dealing with here
setwd(here())
here::here()
library(here)
